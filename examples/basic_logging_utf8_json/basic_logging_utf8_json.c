 ...
 * Run with: ./build/examples/basic_logging_utf8/basic_logging_utf8
 */
...
int main(void) {
  printf("Basic Logging UTF-8 Example\n");
  printf("============================\n\n");

  /* Initialize basic logging with UTF-8 support enabled */
  clogging_log_options_t opts = {
    .color = 1,
    .json = 1,
    .prefix_fields_flag = CLOGGING_PREFIX_DEFAULT
  };
  clogging_basic_init("basic_utf8_demo", 15 + 1, "", 0, LOG_LEVEL_INFO, &opts);
